...
// include: C:\Users\Jack\AppData\Local\Temp\tmp2ci39i3i.js
...
Module['FS_createPath']("/assets", "sound", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/font/NES.ttf", "start": 0, "end": 163076}, {"filename": "/assets/image/ball_default.png", "start": 163076, "end": 163207}, {"filename": "/assets/image/block_blue.png", "start": 163207, "end": 163406}, {"filename": "/assets/image/block_brown.png", "start": 163406, "end": 163602}, {"filename": "/assets/image/block_green.png", "start": 163602, "end": 163805}, {"filename": "/assets/image/block_pink.png", "start": 163805, "end": 164000}, {"filename": "/assets/image/button_play_again.png", "start": 164000, "end": 164782}, {"filename": "/assets/image/button_pressed_play_again.png", "start": 164782, "end": 165537}, {"filename": "/assets/image/game_over_panel.png", "start": 165537, "end": 166436}, {"filename": "/assets/image/game_over_panel_blue.png", "start": 166436, "end": 167332}, {"filename": "/assets/image/icon.png", "start": 167332, "end": 167637}, {"filename": "/assets/image/icon2.png", "start": 167637, "end": 167940}, {"filename": "/assets/image/paddle.png", "start": 167940, "end": 168115}, {"filename": "/assets/image/paddle_small.png", "start": 168115, "end": 168286}, {"filename": "/assets/image/paddle_wide.png", "start": 168286, "end": 168463}, {"filename": "/assets/sound/ball.wav", "start": 168463, "end": 172187}, {"filename": "/assets/sound/brick.wav", "start": 172187, "end": 176647}, {"filename": "/assets/sound/button_pressed.wav", "start": 176647, "end": 187145}, {"filename": "/assets/sound/game_over.wav", "start": 187145, "end": 225207}, {"filename": "/assets/sound/level_complete.wav", "start": 225207, "end": 290743}], "remote_package_size": 290743});

  })();

// end include: C:\Users\Jack\AppData\Local\Temp\tmp2ci39i3i.js
// include: C:\Users\Jack\AppData\Local\Temp\tmpkds0fn1e.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\Jack\AppData\Local\Temp\tmpkds0fn1e.js
// include: C:\Users\Jack\AppData\Local\Temp\tmp2c90eaw2.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\Jack\AppData\Local\Temp\tmp2c90eaw2.js
...
function findWasmBinary() {
  return locateFile('breakout.wasm');
}
...
var ASM_CONSTS = {
  135528: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 137686: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 137850: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 137954: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 138125: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(Module.HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == miniaudio.device_type.playback || deviceType == miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return miniaudio.track_device(device); },  
 140953: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 141019: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 141412: ($0) => { miniaudio.untrack_device_by_index($0); },  
 141455: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 141580: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; },  
 141706: () => { if (document.fullscreenElement) return 1; },  
 141752: () => { return document.getElementById('canvas').width; },  
 141804: () => { return parseInt(document.getElementById('canvas').style.width); },  
 141872: () => { document.exitFullscreen(); },  
 141899: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 141972: () => { if (document.fullscreenElement) return 1; },  
 142018: () => { return document.getElementById('canvas').width; },  
 142070: () => { return screen.width; },  
 142095: () => { document.exitFullscreen(); },  
 142122: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 142255: () => { return window.innerWidth; },  
 142281: () => { return window.innerHeight; },  
 142308: () => { if (document.fullscreenElement) return 1; },  
 142354: () => { return document.getElementById('canvas').width; },  
 142406: () => { return parseInt(document.getElementById('canvas').style.width); },  
 142474: () => { if (document.fullscreenElement) return 1; },  
 142520: () => { return document.getElementById('canvas').width; },  
 142572: () => { return screen.width; },  
 142597: () => { return window.innerWidth; },  
 142623: () => { return window.innerHeight; },  
 142650: () => { if (document.fullscreenElement) return 1; },  
 142696: () => { return document.getElementById('canvas').width; },  
 142748: () => { return screen.width; },  
 142773: () => { document.exitFullscreen(); },  
 142800: () => { if (document.fullscreenElement) return 1; },  
 142846: () => { return document.getElementById('canvas').width; },  
 142898: () => { return parseInt(document.getElementById('canvas').style.width); },  
 142966: () => { document.exitFullscreen(); },  
 142993: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 143051: () => { return screen.width; },  
 143076: () => { return screen.height; },  
 143102: () => { return window.screenX; },  
 143129: () => { return window.screenY; },  
 143156: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 143209: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 143280: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 143337: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 143593: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 143664: () => { if (document.fullscreenElement) return 1; },  
 143710: () => { return window.innerWidth; },  
 143736: () => { return window.innerHeight; },  
 143763: () => { if (document.pointerLockElement) return 1; }
};
